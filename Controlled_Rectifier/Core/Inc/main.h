...
/* Private defines -----------------------------------------------------------*/
#define Zero_negative_Pin GPIO_PIN_7
#define Zero_negative_GPIO_Port GPIOB
#define Zero_negative_EXTI_IRQn EXTI4_15_IRQn
#define Zero_positive_Pin GPIO_PIN_0
#define Zero_positive_GPIO_Port GPIOA
#define Zero_positive_EXTI_IRQn EXTI0_1_IRQn
